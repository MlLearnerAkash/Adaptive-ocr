...
parser.add_argument('--store_probability', type=str, default='no')


#Semi supervised
parser.add_argument('--type', type=str, default="semi")
parser.add_argument('--source_imgs_dir', type=str, default="", help="txt file containing images for data")
parser.add_argument('--source_labels_dir', type= str, default = "", help="txt file for labels")
parser.add_argument('--target_imgs_dir',type=str, default="", help="target dir where images will be saved")
parser.add_argument('--lmdb_dir', type= str, default="target_lmdb", help="tmp path to store lmdb")
