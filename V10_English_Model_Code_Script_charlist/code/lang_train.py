import sys
import os
from base_train_semi_supervised import *
# from base_train_wo_cnn_freezing import *
...
l1 = ['assamese','bengali', 'meetei', 'bodo', 'english','gujarati','punjabi','hindi','manipuri','marathi','oriya','urdu'] # indo-aryan languages smaller wdith
